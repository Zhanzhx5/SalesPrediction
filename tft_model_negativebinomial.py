...
class TFTModel:
    ...
    def train_model(self):
        ...
        early_stop_callback = pl.callbacks.EarlyStopping(
            monitor="val_loss", min_delta=1e-5, patience=self.patience, verbose=False, mode="min",
            check_on_train_epoch_end=False  # 确保在验证结束后再检查早停指标
        )
        ...
        checkpoint_callback = pl.callbacks.ModelCheckpoint(
            ...
            save_on_train_epoch_end=False  # 在验证结束后依据最新val_loss保存
        )
